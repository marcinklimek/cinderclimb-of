...
ofSettings::ofSettings()
{
    ...
    parameters.add(blur_amount.set("blur amount", 15, 1, 30));
    parameters.add(brightness.set("brightness", 0.28f, 0.0f, 1.0f));
    parameters.add(contrast.set("contrast", 0.28f, 0.0f, 1.0f));
    parameters.add(erode_count.set("erosion", 6, 1, 15));
    parameters.add(dillate_count.set("dillate", 6, 1, 15));
    ...
    parameters.add(learingRate.set("learing rate", 0.05f, -1.0f, 1.0f));
