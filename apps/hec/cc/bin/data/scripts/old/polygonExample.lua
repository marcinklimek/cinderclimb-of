...
function draw()
	...
	-- of.drawBitmapString("(a) star winding rule odd", 20.0, 210.0, 0)
	
	of.setHexColor(0x000000)
	-- of.drawBitmapString("(b) star winding rule nonzero", 220, 210, 0)
	
	of.setHexColor(0x000000)
	-- of.drawBitmapString("(c) dynamically\ncreated shape", 420, 210, 0)
	
	of.setHexColor(0x000000)
	-- of.drawBitmapString("(d) random points\npoly", 670, 210, 0)
	
	of.setHexColor(0x000000)
	-- of.drawBitmapString("(e) fun with sin/cos", 20, 410, 0)
	
	of.setHexColor(0x000000)
	-- of.drawBitmapString("(f) ofCurveVertex\nuses catmull rom\nto make curved shapes", 220, 410, 0)
	
	of.setHexColor(0x000000)
	-- of.drawBitmapString("(g) ofBezierVertex\nuses bezier to draw curves", 460, 410, 0)
	
	
	of.setHexColor(0x000000)
	-- of.drawBitmapString("(h) ofNextContour\nallows for holes", 20, 610, 0)
	
	of.setHexColor(0x000000)
	-- of.drawBitmapString("(i) ofNextContour\ncan even be used for CSG operations\nsuch as union and intersection", 260, 620, 0)
end
