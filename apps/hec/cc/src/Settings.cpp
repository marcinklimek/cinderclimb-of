...
ofSettings::ofSettings()
{
    ...
    parameters.add(erode_open_count.set("erosion open", 0, 1, 30));
	parameters.add(erode_close_count.set("erosion close", 2, 1, 30));
    parameters.add(dillate_count.set("dillate", 3, 1, 30));
